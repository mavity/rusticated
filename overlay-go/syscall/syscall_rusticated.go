// This file replaces syscall/syscall_wasip1.go for the rusticated WASM host.
// It replaces the WASI clock import with the rusticated env.get_time ABI.
...
// SetNonblock is provided by fs_rusticated.go
