//! Raw Linux syscall macros using inline assembly.
#![allow(dead_code)]
    ...
    ($nr:expr) => {
        {
            ...
            if (res as isize) < 0 && (res as isize) >= -4095 {
                unsafe { $crate::io::ERRNO = -(res as i32); }
            }
            res
        }
    };
...
pub mod nr {
    ...
    pub const RT_SIDSUSPEND: usize = 133;
