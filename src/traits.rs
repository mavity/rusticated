...
pub trait AsyncRead {
    ...
    async fn read(&mut self, buf: crate::vec::Vec<u8>) -> (crate::io::Result<usize>, crate::vec::Vec<u8>);
}
...
pub trait AsyncWrite {
    ...
    async fn write(&mut self, buf: crate::vec::Vec<u8>) -> (crate::io::Result<usize>, crate::vec::Vec<u8>);
